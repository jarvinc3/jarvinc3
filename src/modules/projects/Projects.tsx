...
import { useProjects, useSectionClick } from '@/hooks';
                        ...
                        >
                           ...
                           <div
                              className={cn(
                                 ...
                                 "w-full h-32 p-3 pr-4 m-1 flex items-end justify-between gap-3",
                                 "transition-all duration-300",
                              )}
                           >
                              <button
                                 onClick={() => (setProject(project.id), setClickedSection(Section.PROJECT))}
                                 className={cn(
